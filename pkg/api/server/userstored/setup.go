...
func Setup(ctx context.Context, mgmt *config.ScaledContext, clusterManager *clustermanager.Manager, k8sProxy http.Handler) error {
	...
	addProxyStore(ctx, schemas, mgmt, client.PrometheusType, "monitoring.cattle.io/v1", nil)
	addProxyStore(ctx, schemas, mgmt, client.PrometheusRuleType, "monitoring.cattle.io/v1", nil)
	addProxyStore(ctx, schemas, mgmt, client.AlertmanagerType, "monitoring.cattle.io/v1", nil)
	addProxyStore(ctx, schemas, mgmt, client.ServiceMonitorType, "monitoring.cattle.io/v1", nil)
