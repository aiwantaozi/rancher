...
func NewLoggingTargetTestWrap(es *v3.ElasticsearchConfig, sp *v3.SplunkConfig, sl *v3.SyslogConfig, kf *v3.KafkaConfig, ff *v3.FluentForwarderConfig, cc *v3.CustomTargetConfig) LoggingTargetTestWrap {
	if es != nil {
		...
		return &customTargetTestWrap{cc}
	}
