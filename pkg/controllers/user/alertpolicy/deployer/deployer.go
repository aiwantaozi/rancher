...
func (d *Deployer) ProjectSync(key string, alert *v3.ProjectAlertPolicy) error {
	return d.sync()
}

func (d *Deployer) ClusterSync(key string, alert *v3.ClusterAlertPolicy) error {
	return d.sync()
}
...
func (d *Deployer) needDeploy() (bool, error) {
	...
	clusterAlerts, err := d.clusterAlertPolicyLister.List("", labels.NewSelector())
	if err != nil {
		return false, err
	}
	...
	projectAlerts, err := d.projectAlertPolicyLister.List("", labels.NewSelector())
	if err != nil {
		return false, nil
	}
...
func (d *Deployer) cleanup() error {
	...
	err := d.nsClient.Delete(monitorutil.SystemMonitoringNamespaceName, &metav1.DeleteOptions{})
...
func (d *Deployer) deploy() error {
	...
	ns := &corev1.Namespace{
		ObjectMeta: metav1.ObjectMeta{
			Name: monitorutil.SystemMonitoringNamespaceName,
		},
	}
