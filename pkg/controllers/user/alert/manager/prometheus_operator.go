...
func (c *PromOperatorCRDManager) AddRule(ruleGroup *monitoringv1.RuleGroup, ruleName, displayName, serverity string, metric *v3.MetricRule) {
	r := Metric2Rule(ruleGroup.Name, ruleName, displayName, serverity, c.clusterName, metric)
	ruleGroup.Rules = append(ruleGroup.Rules, r)
}

func Metric2Rule(groupName, ruleName, serverity, displayName, clusterName string, metric *v3.MetricRule) monitoringv1.Rule {
