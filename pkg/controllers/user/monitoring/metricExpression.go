...
---
# Source: metric-expression/templates/graphapiserver.yaml
...
spec:
  ...
  yAxis:
    unit: number
---
# Source: metric-expression/templates/graphcluster.yaml
apiVersion: management.cattle.io/v3
kind: ClusterMonitorGraph
metadata:
  labels:
...
spec:
  ...
  yAxis:
    unit: pps
---
# Source: metric-expression/templates/graphcontrollermanager.yaml
---
apiVersion: management.cattle.io/v3
kind: ClusterMonitorGraph
metadata:
...
---
# Source: metric-expression/templates/graphetcd.yaml
---
apiVersion: management.cattle.io/v3
kind: ClusterMonitorGraph
metadata:
...
spec:
  ...
  yAxis:
    unit: seconds
---
# Source: metric-expression/templates/graphfluentd.yaml
apiVersion: management.cattle.io/v3
kind: ClusterMonitorGraph
metadata:
  labels:
...
spec:
  ...
  yAxis:
    unit: number
---
# Source: metric-expression/templates/graphingresscontroller.yaml
apiVersion: management.cattle.io/v3
kind: ClusterMonitorGraph
metadata:
  labels:
...
spec:
  ...
  type: singlestat
---
# Source: metric-expression/templates/graphnode.yaml
apiVersion: management.cattle.io/v3
kind: ClusterMonitorGraph
metadata:
  labels:
...
spec:
  ...
  yAxis:
    unit: pps
---
# Source: metric-expression/templates/graphscheduler.yaml
apiVersion: management.cattle.io/v3
kind: ClusterMonitorGraph
metadata:
  labels:
...
spec:
  ...
  yAxis:
    unit: number
---
# Source: metric-expression/templates/expressionapiserver.yaml
kind: MonitorMetric
apiVersion: management.cattle.io/v3
metadata:
...
---
# Source: metric-expression/templates/expressioncluster.yaml
kind: MonitorMetric
apiVersion: management.cattle.io/v3
metadata:
...
spec:
  expression: sum(rate(node_network_receive_errs_total{device!~"lo|veth.*|docker.*|flannel.*|cali.*|cbr.*"}[5m]))
    by (instance)
  legendFormat: Receive error([[instance]])
  description: cluster network receive errors sum
---
kind: MonitorMetric
apiVersion: management.cattle.io/v3
...
spec:
  expression: sum(rate(node_network_receive_drop_total{device!~"lo|veth.*|docker.*|flannel.*|cali.*|cbr.*"}[5m]))
    by (instance)
  legendFormat: Receive droppped([[instance]])
  description: cluster network receive packets dropped sum
---
kind: MonitorMetric
apiVersion: management.cattle.io/v3
...
spec:
  expression: sum(rate(node_network_transmit_drop_total{device!~"lo|veth.*|docker.*|flannel.*|cali.*|cbr.*"}[5m]))
    by (instance)
  legendFormat: Transmit drop([[instance]])
  description: cluster network transmit packets dropped sum
---
kind: MonitorMetric
apiVersion: management.cattle.io/v3
...
---
# Source: metric-expression/templates/expressioncontainer.yaml
kind: MonitorMetric
apiVersion: management.cattle.io/v3
metadata:
...
spec:
  expression: sum(rate(container_cpu_usage_seconds_total{namespace=~"$namespace",pod_name=~"$podName",
    container_name=~"$containerName"}[5m])) by (container_name)
  legendFormat: CPU usage seconds([[container_name]])
  description: container cpu usage seconds sum rate
---
kind: MonitorMetric
apiVersion: management.cattle.io/v3
...
---
# Source: metric-expression/templates/expressioncontrollermanager.yaml
kind: MonitorMetric
apiVersion: management.cattle.io/v3
metadata:
...
---
# Source: metric-expression/templates/expressionetcd.yaml
kind: MonitorMetric
apiVersion: management.cattle.io/v3
metadata:
  name: etcd-server-failed-proposal
...
---
# Source: metric-expression/templates/expressionfluentd.yaml
kind: MonitorMetric
apiVersion: management.cattle.io/v3
metadata:
...
---
# Source: metric-expression/templates/expressioningresscontroller.yaml
kind: MonitorMetric
apiVersion: management.cattle.io/v3
metadata:
...
metadata:
  ...
  labels:
    ...
    source: rancher-monitoring
spec:
  expression: max(request_duration_seconds_bucket{le="1"}) 
  legendFormat: Request duration([[host]]:[[path]])
  description: ingresscontroller nginx request duration by path
---

---
# Source: metric-expression/templates/expressionnode.yaml
kind: MonitorMetric
apiVersion: management.cattle.io/v3
metadata:
...
---
# Source: metric-expression/templates/expressionpod.yaml
kind: MonitorMetric
apiVersion: management.cattle.io/v3
metadata:
...
spec:
  expression: sum(rate(container_network_receive_packets_total{namespace=~"$namespace",pod_name=~"$podName",
    container_name!=""}[5m])) by (container_name)
  legendFormat: Receive([[container_name]])
  description: pod network receive packets sum rate
---
kind: MonitorMetric
apiVersion: management.cattle.io/v3
...
spec:
  expression: sum(rate(container_cpu_usage_seconds_total{namespace=~"$namespace",pod_name=~"$podName",
    container_name!=""}[5m])) 
  legendFormat: CPU usage seconds
  description: pod cpu usage seconds sum rate
---
kind: MonitorMetric
apiVersion: management.cattle.io/v3
metadata:
...
---
# Source: metric-expression/templates/expressionscheduler.yaml
kind: MonitorMetric
apiVersion: management.cattle.io/v3
metadata:
  name: scheduler-e-2-e-scheduling-latency-seconds-quantile
...
---
# Source: metric-expression/templates/expressionworkload.yaml
kind: MonitorMetric
apiVersion: management.cattle.io/v3
metadata:
