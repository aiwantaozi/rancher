...
type ClusterLoggingOperations interface {
	...
	ActionDryRun(resource *ClusterLogging, input *ClusterTestInput) error

	ActionTest(resource *ClusterLogging, input *ClusterTestInput) error
...
func (c *ClusterLoggingClient) ActionDryRun(resource *ClusterLogging, input *ClusterTestInput) error {
	err := c.apiClient.Ops.DoAction(ClusterLoggingType, "dryRun", &resource.Resource, input, nil)
	return err
}

func (c *ClusterLoggingClient) ActionTest(resource *ClusterLogging, input *ClusterTestInput) error {
