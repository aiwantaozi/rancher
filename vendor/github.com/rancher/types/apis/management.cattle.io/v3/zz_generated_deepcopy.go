...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LoggingInput) DeepCopyInto(out *LoggingInput) {
	*out = *in
	if in.Endpoints != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoggingInput.
func (in *LoggingInput) DeepCopy() *LoggingInput {
	if in == nil {
		return nil
	}
	out := new(LoggingInput)
	in.DeepCopyInto(out)
	return out
}
